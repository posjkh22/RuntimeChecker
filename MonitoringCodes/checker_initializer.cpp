...
extern "C" void checker_initializer(unsigned int node_id)
{
	...
	add_basicblock(p_pathtree, 0x10002, 1, 0x10004, 0x0);
	add_basicblock(p_pathtree, 0x10003, 1, 0x10004, 0x0);
	add_basicblock(p_pathtree, 0x10004, 0, 0x0, 0x0);
	add_basicblock(p_pathtree, 0x20001, 2, 0x20002, 0x20003);
	add_basicblock(p_pathtree, 0x20002, 3, 0x10001, 0x20003);
	add_basicblock(p_pathtree, 0x20003, 4, 0x0, 0x0);
...
Pathtree* generate_path_tree()
{
	...
	BBInfo* t_bb = new BBInfo(0x00000001, 1, 0x20001, 0);
