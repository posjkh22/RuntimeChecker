...
/* wTask */
bool wTask::setEntryFunc(wFunction *wf){
	EntryFunc = wf;
	return true;
}

wFunction *wTask::getEntryFunc(){
	return EntryFunc;
}

bool wTask::pushFuncList(wFunction *f){
	wFuncList.push_back(f);
	return true;
}

std::list<wFunction *> *wTask::getwFuncList(){
	return &wFuncList;
}

wFunction* wTask::SearchFunction(Function* f){
...
wFunction* wTask::SearchFunction(const std::string &name){
...
bool wTask::ShowPathsInEachFunc(){
...
std::list<std::list<wBasicBlock *> *> *wTask::getGlobalPathsList(){
	return &GlobalPathsList;
}

bool wTask::ShowTempPathsList(std::list<std::list<wBasicBlock *> *> *PathsList){
...
bool wTask::insertPath(std::list<std::list<wBasicBlock *> *> **pResult, std::list<wBasicBlock *> *Target, wBasicBlock *CallBB, std::list<std::list<wBasicBlock *> *> *Inserted){
...
std::list<wBasicBlock *>::iterator wTask::SearchwBlock(std::list<wBasicBlock *> *TargetPath, wBasicBlock *BB){
...
bool wTask::makeGlobalPathsList(std::list<std::list<wBasicBlock *> *> *insertedPathList){
